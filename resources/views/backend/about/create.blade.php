                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="file-repeater">Add New About </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                                  @if ($errors->any())
                                                       ...
                                                       @endif
                                        <form class="form row" action="{{ route('About.store') }}" method="post" enctype="multipart/form-data">
                                             @csrf
                                            <div class="form-group col-md-12 mb-2">
                                            <label for="inputProductTitle" class="form-label">Title Arabic </label>
                                           <input type="text" class="form-control" placeholder="about title" name="title_ar">
                                            </div>
