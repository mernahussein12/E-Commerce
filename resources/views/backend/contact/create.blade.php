...
<div class="content-wrapper">
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title mb-0"> Add Contacts </h3>
        </div>
               ...
               @endif
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <form class="form row" action="{{ route('Contact.store') }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                            
                                            <div class="form-group col-md-6 mb-2">
                                                <label for="donationinput1">Arabic Title</label>
                                                <input type="text" class="form-control" placeholder="Arabic Name" name="title_ar">
                                            </div>
                                            <div class="form-group col-md-6 mb-2">
                                                <label for="donationinput1">English tiltle</label>
                                                <input type="text" class="form-control" placeholder="English Name" name="title_en">
                                            </div>
                                              <div class="form-group col-md-6 mb-2">
                                            ...
                                            <div class="form-group col-md-6 mb-2">
                                                ...
                                                <input type="text" class="form-control" placeholder="English address" name="address_en">
                                            </div>
                                          <div class="form-group col-md-6 mb-2">
